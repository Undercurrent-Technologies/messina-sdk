...
(async () => {
  ...
  await createAndSendV0Tx(connection, [payer, message], [approveIx, initIx]);
  // 41GpbwQGXq2rh77i1uidBdRdhbvChpVJPsiagcikpdnZHCLprbkWzg9m4fswTexkWseg8N41rStpJpq2G8RkH4AW
})();

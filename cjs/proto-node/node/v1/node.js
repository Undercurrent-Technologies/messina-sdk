 ...
 */
exports.NodePrivilegedServiceService = {
    /**
    ...
    injectGovernanceVAA: {
        ...
        requestSerialize: function (value) {
            return Buffer.from(exports.InjectGovernanceVAARequest.encode(value).finish());
        },
        requestDeserialize: function (value) {
            return exports.InjectGovernanceVAARequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.InjectGovernanceVAAResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.InjectGovernanceVAAResponse.decode(value);
        },
    },
    /**
    ...
    findMissingMessages: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.FindMissingMessagesRequest.encode(value).finish());
        },
        requestDeserialize: function (value) {
            return exports.FindMissingMessagesRequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.FindMissingMessagesResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.FindMissingMessagesResponse.decode(value);
        },
    },
};
exports.NodePrivilegedServiceClient = grpc_js_1.makeGenericClientConstructor(exports.NodePrivilegedServiceService, "node.v1.NodePrivilegedService");

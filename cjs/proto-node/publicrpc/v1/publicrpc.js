...
exports.PublicRPCServiceService = {
    /**
    ...
    getLastHeartbeats: {
        ...
        requestSerialize: function (value) {
            return Buffer.from(exports.GetLastHeartbeatsRequest.encode(value).finish());
        },
        requestDeserialize: function (value) {
            return exports.GetLastHeartbeatsRequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetLastHeartbeatsResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.GetLastHeartbeatsResponse.decode(value);
        },
    },
    getSignedVAA: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.GetSignedVAARequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.GetSignedVAARequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetSignedVAAResponse.encode(value).finish());
        },
        responseDeserialize: function (value) { return exports.GetSignedVAAResponse.decode(value); },
    },
    getCurrentGuardianSet: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.GetCurrentGuardianSetRequest.encode(value).finish());
        },
        requestDeserialize: function (value) {
            return exports.GetCurrentGuardianSetRequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetCurrentGuardianSetResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.GetCurrentGuardianSetResponse.decode(value);
        },
    },
};
exports.PublicRPCServiceClient = grpc_js_1.makeGenericClientConstructor(exports.PublicRPCServiceService, "publicrpc.v1.PublicRPCService");

...
export function createUpdateWrappedInstruction(
  tokenBridgeProgramId: PublicKeyInitData,
  wormholeProgramId: PublicKeyInitData,
  payer: PublicKeyInitData,
  mintPubkey: PublicKeyInitData,
  ...
  // @ts-ignore
  return methods._ixFn(...methods._args, {
    accounts: getUpdateWrappedAccounts(
      tokenBridgeProgramId,
      wormholeProgramId,
      payer,
      mintPubkey,
...
export interface UpdateWrappedAccounts {
  payer: PublicKey;
  config: PublicKey;
  tokenConfig: PublicKey;
  endpoint: PublicKey;
...
export function getUpdateWrappedAccounts(
  tokenBridgeProgramId: PublicKeyInitData,
  wormholeProgramId: PublicKeyInitData,
  payer: PublicKeyInitData,
  mintPubkey: PublicKeyInitData,
  vaa: SignedVaa | ParsedAttestMetaVaa
): UpdateWrappedAccounts {
  const parsed = isBytes(vaa) ? parseAttestMetaVaa(vaa) : vaa;
  const mint = new PublicKey(mintPubkey);
